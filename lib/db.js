...
var allTimesStmt = db.prepare("SELECT projects.name, start_time, end_time FROM projects, times WHERE projects.id = project_id AND projects.finished = 0;", printError);
...
exports.getAllTimes = function(callback) {
  allTimesStmt.all(callback);
};
